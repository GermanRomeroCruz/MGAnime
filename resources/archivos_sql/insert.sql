...
INSERT INTO USUARIO (NOMBRE,PASS,EMAIL,IMAGEN,ROL)
 ...
 ('Berserk', 'Miura, Kentarou', '/imgs/publicacion/6/berserk.jpg', 'Guts, un ex mercenario ahora conocido como el "Espadachín Negro", busca venganza.','Acción'),
 ('One Piece', 'Oda, Eiichiro', '/imgs/publicacion/7/onepiece.jpg', 'Gol D. Roger, un hombre conocido como el "Rey Pirata", será ejecutado por el Gobierno Mundial.','Aventura'),
 ('Fullmetal Alchemist', 'Arakawa, Hiromu', '/imgs/publicacion/8/fullmetal.jpg', 'Los alquimistas son personas con conocimientos y talento natural que pueden manipular y modificar la materia gracias a su arte.','Acción'),
 ('Oyasumi Punpun', 'Asano, Inio', '/imgs/publicacion/9/oyasumi.jpg', 'Punpun Onodera es un niño normal de 11 años que vive en Japón. Sin esperanza, idealista y romántico, Punpun comienza a ver que su vida toma un giro sutil, aunque sorprendente, hacia el adulto cuando conoce a la nueva chica de su clase, Aiko Tanaka.','Drama'),
 ('¡¡Haikyuu !!', 'Furudate, Haruichi', '/imgs/publicacion/10/haikyuu.png', 'Vóleibol. Un deporte en el que se enfrentan dos equipos, separados por una formidable red en forma de muro.','Comedia'),
 ('Koe no Katachi', 'Ooima, Yoshitoki', '/imgs/publicacion/11/koe.jpg', 'Shouya Ishida, un chico que siempre busca formas de vencer el aburrimiento, termina buscándolo en el lugar equivocado.','Drama'),
 ('Houseki no Kuni', 'Ichikawa, Haruko', '/imgs/publicacion/12/kuni.jpg', 'Hace mucho tiempo, la Tierra fue golpeada por seis meteoritos, creando seis lunas y dejando una isla solitaria a su paso.','Acción'),
 ('Jumyou wo Kaitotte Moratta.', 'Taguchi, Shouichi', '/imgs/publicacion/13/jumyou.jpg', 'Indefenso y luchando por conseguir dinero en efectivo, Kusunoki, de 20 años, vende sus últimas posesiones para comprar comida.','Drama'),
 ('One Punch-Man', ' Murata, Yusuke, ONE', '/imgs/publicacion/14/onepunch.jpeg', 'Después de entrenar rigurosamente durante tres años, el Saitama ordinario ha ganado una fuerza inmensa que le permite derrotar a cualquiera y cualquier cosa con un solo golpe.','Acción'),
 ('Hunter x Hunter', 'Togashi, Yoshihiro', '/imgs/publicacion/15/hunter.jpg', 'Tesoros secretos, riquezas por descubrir ... lugares místicos, fronteras inexploradas ... "El misterioso desconocido". Hay magia en esas palabras para aquellos cautivados por su hechizo. ¡Se llaman "Cazadores"!','Aventura'),
 ('Yagate Kimi ni Naru', 'Nakatani, Nio', '/imgs/publicacion/16/naru.jpg', 'Yuu Koito siempre ha disfrutado del manga romántico y las canciones de amor. Se aferra a ellos con la esperanza de que algún día experimentará su propia historia de amor, una que la hará perder el control y hará que su corazón se acelere.','Escuela'),
 ('Attack on Titan', 'Isayama, Hajime', '/imgs/publicacion/17/titan.jpeg', 'Hace cientos de años, aparecieron horribles criaturas que se parecían a los humanos. Estos gigantes inmensos e inconscientes, llamados "titanes", demostraron ser una amenaza existencial, ya que se aprovecharon de cualquier humano que pudieran encontrar para satisfacer un apetito aparentemente interminable.','Acción'),
 ('Pandora Hearts', 'Mochizuki, Jun', '/imgs/publicacion/18/pandora.png', 'Con reminiscencias de una caja de juguetes rota, el místico Abismo es un reino aterrador que alberga criaturas monstruosas llamadas "Cadenas".','Fantasía'),
 ('Gintama', 'Sorachi, Hideaki', '/imgs/publicacion/19/gintana.jpg', 'Durante el período Edo, Japón es repentinamente invadido por criaturas alienígenas conocidas como "Amanto".','Acción'),
 ('Tokyo Ghoul', ' Ishida, Sui', '/imgs/publicacion/20/ghoul.jpg', 'Acechando entre las sombras de Tokio hay seres aterradores conocidos como "ghouls", que satisfacen su hambre alimentándose de humanos una vez que cae la noche.','Terror'),
 ('Chihayafuru', 'Suetsugu, Yuki', '/imgs/publicacion/21/chiha.jpg', 'Siempre considerada inferior a su hermana mayor, Chihaya Ayase, de voluntad fuerte pero sin rumbo, no tiene ningún sueño propio.','Juegos'),
 ('Bakemonogatari', 'Nisio, ISin', '/imgs/publicacion/22/bake.jpg', 'Koyomi Araragi no es ajeno a lo anormal. Durante las vacaciones de primavera de su tercer año en la escuela secundaria, un fatídico encuentro con el vampiro Kiss-Shot Acerola-Orion Heart-Under-Blade lo convierte en un vampiro.','Vampiros'),
 ('Golden Kamuy', 'Noda, Satoru', '/imgs/publicacion/23/golden.png', 'Saichi Sugimoto es temido como el "Sugimoto inmortal" por su salvajismo en el campo de batalla durante la guerra ruso-japonesa, pero de ninguna manera es un héroe de guerra.','Histórico'),
 ('Fruits Basket', 'Takaya, Natsuki', '/imgs/publicacion/24/fruba.jpg', 'Tooru Honda es huérfana y no tiene adónde ir más que una tienda de campaña en el bosque, hasta que la familia Souma la acoge.','Comedia'),
 ('Hinamatsuri', 'Ohtake, Masao', '/imgs/publicacion/25/hina.jpg', 'Yoshifumi Nitta, un yakuza de nivel medio, encuentra su vida cambiada para siempre cuando aparece una extraña cápsula y se estrella contra su cabeza.','Comedia'),
 ('Kimi no Suizou wo Tabetai', 'Kirihara, Idumi, Sumino, Yoru', '/imgs/publicacion/26/pancreas.jpg', 'La historia de la novela se cuenta desde el punto de vista de un protagonista anónimo que un día encuentra un diario en un hospital.','Drama'),
 ('Ookami a Koushinryou', 'Koume, Keito, Hasekura, Isuna', '/imgs/publicacion/27/okami.jpg', 'Soñando con tener algún día su propia tienda, el comerciante ambulante Kraft Lawrence pasa sus días buscando oportunidades comerciales.','Aventura'),
 ('Noragami', 'Adachitoka', '/imgs/publicacion/28/noragami.jpg', 'Como una deidad menor relativamente desconocida sin ningún adorador, Delivery God Yato acepta trabajos ocasionales por solo cinco yenes, con el objetivo de amasar una fortuna lo suficientemente grande como para comprarse un santuario.','Acción'),
 ('Kuroshitsuji', 'Toboso, Yana', '/imgs/publicacion/29/kuroshitsuji.jpg', 'Escondida en la campiña inglesa se encuentra la ominosa mansión de los Phantomhives, una familia que se ha establecido como la fría y despiadada "Reina del perro guardián", así como la cabeza de la clandestinidad criminal de Londres.','Sobrenatural'),
 ('Kimi no Na wa', ' Shinkai, Makoto, Kotone, Ranmaru', '/imgs/publicacion/30/nawa.jpg', 'Mitsuha Miyamizu es una estudiante de secundaria que vive en la ciudad rural de Itomori. Anhela una vida en Tokio porque está harta de vivir en el campo.','Romance');
